 ...
 */
final class Version20180907084010 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customers ADD firstname VARCHAR(255) NOT NULL, ADD lastname VARCHAR(255) NOT NULL, DROP first name, DROP last name, CHANGE email email VARCHAR(255) NOT NULL, CHANGE phone phone VARCHAR(255) NOT NULL, CHANGE address address VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customers ADD first name VARCHAR(50) NOT NULL COLLATE utf8_general_ci, ADD last name VARCHAR(50) NOT NULL COLLATE utf8_general_ci, DROP firstname, DROP lastname, CHANGE phone phone VARCHAR(50) NOT NULL COLLATE utf8_general_ci, CHANGE email email VARCHAR(50) NOT NULL COLLATE utf8_general_ci, CHANGE address address VARCHAR(50) NOT NULL COLLATE utf8_general_ci');
