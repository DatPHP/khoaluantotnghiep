 ...
 */
final class Version20180912090931 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD create_date DATE NOT NULL, CHANGE customer_id customer_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders DROP create_date, CHANGE customer_id customer_id VARCHAR(50) NOT NULL COLLATE utf8_general_ci');
