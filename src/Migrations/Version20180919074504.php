 ...
 */
final class Version20180919074504 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders CHANGE created_date created_date VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders CHANGE created_date created_date DATETIME DEFAULT NULL');
