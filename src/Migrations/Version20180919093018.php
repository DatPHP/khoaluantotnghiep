 ...
 */
final class Version20180919093018 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD customer_id_id INT DEFAULT NULL, DROP customer_id, CHANGE created_date created_date VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD customer_id INT NOT NULL, DROP customer_id_id, CHANGE created_date created_date DATETIME DEFAULT NULL');
