 ...
 */
final class Version20190615165717 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders CHANGE created_date created_date VARCHAR(255) NOT NULL, CHANGE status status VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE orders_items ADD total INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders CHANGE created_date created_date DATE DEFAULT NULL, CHANGE status status VARCHAR(50) DEFAULT \'Pending\' NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE orders_items DROP total');
