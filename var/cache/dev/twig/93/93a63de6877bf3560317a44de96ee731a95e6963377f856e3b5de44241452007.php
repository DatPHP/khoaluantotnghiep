...
class __TwigTemplate_3425b07bca896a0592e13c5603204a7cdad0ddfa6a7ee300c322b2d7658f6797 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["blog_entries"]) || array_key_exists("blog_entries", $context) ? $context["blog_entries"] : (function () { throw new RuntimeError('Variable "blog_entries" does not exist.', 7, $this->source); })()));
        ...
        <p>";
            // line 9
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["entry"], "body", [], "any", false, false, false, 9), "html", null, true);
            echo "</p>
    ";
        }
    ...
    {
        return array (  98 => 9,  93 => 8,  88 => 7,  78 => 6,  59 => 4,  36 => 2,);
    }
...
{% block body %}
    {% for entry in blog_entries %}
        ...
        <p>{{ entry.body }}</p>
    {% endfor %}
{% endblock %}", "blog/index.html.twig", "/var/www/html/myProject/datshop/templates/blog/index.html.twig");
    }
}
